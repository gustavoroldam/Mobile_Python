...
class BannerVendedor(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        link = f'https://aplicativovendashash-2cfc7-default-rtdb.firebaseio.com/.json?orderBy="id_vendedor"&equalTo="{id_vendedor}"'
        ...
        label_total = LabelButton(text=f"Total de Vendas{total_vendas}", pos_hint={"right":0.9, "top":0.6}, size_hint=(0.5, 0.5), on_release = partial(meu_aplicativo.carregar_vendas_vendedor, valor))
